package me.fainted.clickgui.component.components;
...
import me.fainted.clickgui.ClickGui;
import me.fainted.clickgui.component.Component;
import me.fainted.clickgui.component.Frame;
import me.fainted.clickgui.component.components.sub.Checkbox;
import me.fainted.clickgui.component.components.sub.Keybind;
import me.fainted.clickgui.component.components.sub.ModeButton;
import me.fainted.clickgui.component.components.sub.Slider;
import me.fainted.clickgui.component.components.sub.VisibleButton;
...
public class Button extends Component {
	...
	public Button(Module mod, Frame parent, int offset) {
		...
		height = 12;
		int opY = offset + 12;
		if(Tutorial.instance.settingsManager.getSettingsByMod(mod) != null) {
			for(Setting s : Tutorial.instance.settingsManager.getSettingsByMod(mod)){
				if(s.isCombo()){
