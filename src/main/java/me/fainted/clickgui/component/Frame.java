package me.fainted.clickgui.component;
...
import me.fainted.clickgui.component.components.Button;
...
public class Frame {
	...
	public Frame(Category cat) {
		...
		for(Module mod : Tutorial.instance.moduleManager.getModulesInCategory(category)) {
	...
	public void renderFrame(FontRenderer fontRenderer) {
		...
		fontRenderer.drawStringWithShadow(this.category.name(), (this.x + 2) * 2 + 5, (this.y + 2.5f) * 2 + 5, 0xa9a9a9);
